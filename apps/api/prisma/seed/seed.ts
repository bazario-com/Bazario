  ...
  const productDefs = [
    {
      ...
      discountPct: 22,
      description:
        'Active noise cancellation, 30-hour battery life, and IPX5 water resistance for daily commutes and workouts.',
      isFeatured: true,
    },
    {
      ...
      discountPct: 15,
      description:
        '120Hz AMOLED display, 5000mAh battery, triple camera system with night mode.',
      isFeatured: true,
    },
    {
